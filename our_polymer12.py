...
def calc(var):
    ...
    polymer.create_polymer(N_P=1, MPC=mpc, bond=fene, bond_length=r0, start_pos = [16.0, 16.0, 16.0], mode=2, max_tries=100, shield=0.6*r0)
    ...
    amplVwfVwf = 2.0*kBT    # sometimes we change this to 2.0*kBT  
    rcutVwfVwf = 2.0*r0
    # AVB: the potential
